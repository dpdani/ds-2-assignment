...
// grid 2D block 2D
__global__ void sumMatrixOnGPU2D(const float *MatA, const float *MatB, float *MatC, int nx,
                                 int ny)
{
...
// grid 1D block 1D
__global__ void sumMatrixOnGPU1D(const float *MatA, const float *MatB, float *MatC, int nx,
                                 int ny)
{
    unsigned int ix = threadIdx.x + blockIdx.x * blockDim.x;
...
// grid 2D block 1D
__global__ void sumMatrixOnGPUMix(const float *MatA, const float *MatB, float *MatC, int nx,
                                  int ny)
{
    unsigned int ix = threadIdx.x + blockIdx.x * blockDim.x;
